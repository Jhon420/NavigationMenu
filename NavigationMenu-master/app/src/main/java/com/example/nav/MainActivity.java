...
//Vajalike muutujate lisamine
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToggle = new ActionBarDrawerToggle(this, mDrawerLayout, R.string.open, R.string.close); //Lisab võimaluse Open ja Close

        mDrawerLayout.addDrawerListener(mToggle);
        mToggle.syncState();
        //Saad näha navigatsiooni nuppu.
